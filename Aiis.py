...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: AiisCyber             |"
    print GL+"  |       Berdoa Dulu Sebelum Menggunakan       |"
    print WW+"  |            FACEBOOK: Azis Muslim           |"
    print Y+"  |             INSTAGRAM: Aiis_69             |"
    print GL+"  |---------------------------------------------|"
...
print wd+"         https://www.github.com/Aiiscyber "
...
def life():
	...
	for Aiiscyber in password_nob:
		password_nob = Aiiscyber.replace("\n","")
		Aiis(Aiiscyber)		
